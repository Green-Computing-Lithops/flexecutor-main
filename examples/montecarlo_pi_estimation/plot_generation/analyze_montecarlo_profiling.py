...
if __name__ == "__main__":
    file_path = "examples/montecarlo_pi_estimation/profiling/montecarlo_pi_estimation/monte_carlo_pi_stage.json"
    output_dir = "examples/montecarlo_pi_estimation/plot_generation"
