...
def create_combined_plots(data, output_path=None):
    """Create a professional combined plot with multiple visualizations for Monte Carlo Pi estimation analysis."""
    if output_path is None:
        script_dir = os.path.dirname(os.path.abspath(__file__))
        output_path = os.path.join(script_dir, 'plot_montecarlo_energy_analysis_combined.png')
    ...
    ax1.set_title('Monte Carlo Pi: RAPL Energy vs Compute Performance', fontweight='bold', pad=20)
    ...
    ax2.set_title('Monte Carlo Pi: TDP Energy vs Compute Performance', fontweight='bold', pad=20)
    ...
    ax3.set_title('Single Energy vs Worker Count', fontweight='bold', pad=20)
    ...
    ax5.set_title('Monte Carlo Pi Performance Variability', fontweight='bold', pad=20)
    ...
    plt.close()
    print(f"Professional Monte Carlo Pi energy analysis plots saved to {output_path}")
...
def main():
    """Generate professional energy analysis plots for Monte Carlo Pi estimation."""
    # Path to analysis results
    json_path = '/home/users/iarriazu/flexecutor-main/examples/montecarlo_pi_estimation/plot_generation/analysis_results.json'
    
    print("🚀 Generating professional Monte Carlo Pi energy analysis visualization...")
