...
def merge_json_files(stage_num):
    ...
    # File paths
    source_file = f"video_processing_arm/stage{stage_num}.json"
    target_file = f"video_aws_1024Mb_arm/stage{stage_num}.json"
    output_file = f"video_aws_1024Mb_arm/stage{stage_num}_merged.json"
