...
def load_analysis_data(json_path):
    """Load and parse the 001_analyze_all_profiling_enhanced.json file."""
...
def main():
    ...
    parser.add_argument('analysis_folder', nargs='?', default='001_analysis_results',
                       help='Path to the folder containing analysis JSON files (default: 001_analysis_results)')
    parser.add_argument('--output', '-o', default='010_generate_plot_min_max', 
                       help='Output folder for generated plots (default: 010_generate_plot_min_max)')
