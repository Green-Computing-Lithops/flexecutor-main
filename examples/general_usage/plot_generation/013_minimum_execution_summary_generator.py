...
class ExecutionSummaryGenerator:
    ...
    def __init__(self):
        ...
        self.analysis_dir = self.script_dir / "001_analysis_results"
        self.output_dir = self.script_dir / "013_minimum_execution_summary_generator"
        self.csv_path = self.output_dir / "execution_summary.csv"
    ...
    def extract_data_from_json(self, json_file_path):
        ...
        try:
            ...
            # Handle 001_analyze_all_profiling_enhanced format
